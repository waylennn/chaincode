...
// source: git.querycap.com/cloudchain/chaincode/protos/binary/db.proto
...
func init() {
	proto.RegisterFile("git.querycap.com/cloudchain/chaincode/protos/binary/db.proto", fileDescriptor_4a58fb69f5240f34)
}
